...
class TestIntersection:
    ...
    def test_intersection_3(self):
        ...
        assert intersection(g, h) == BFS(FSA(56, {21, 15, 6, 34, 47, 1, 25, 30, 2, 26}, ('a', 'b', 'c'), 
                                       {'a': [1, 4, 7, 10, 12,  3, 17, 19,  4, 23, 24, 28, 30, 32, 23,  7, 34,  3, 33, 40, 41,  7,  7, 27, 17,  3,  7, 43, 45, 24,  1, 17, 31, 10, 11, 10,  4, 34, 17, 17, 26, 52, 17,  9,  3, 34, 54,  4, 55, 28, 17, 27, 24, 27, 33,  3],
                                        'b': [2, 5, 8, 11, 13, 15, 18, 20, 21, 24, 26,  3, 31, 33,  2,  5, 31, 36, 38, 33, 38,  8, 24, 20, 36, 18,  5, 44, 46, 48,  8,  8, 31, 49,  8, 41, 50, 44,  8, 48,  2, 33, 26, 49, 21, 44, 44,  8, 44, 49, 36, 20,  2, 46, 44,  8],
                                        'c': [3, 6, 9, 12, 14, 16,  6, 21, 22, 25, 27, 29, 25, 10,  1,  6, 35, 37, 39, 29, 42, 15, 35, 14, 12,  6, 29,  6, 47, 25, 10, 28, 25, 28, 50, 29, 39,  6, 51, 35, 17, 29, 19, 10, 53, 29, 10, 15, 29,  9, 37, 21,  7, 49,  6, 51]}))
...
class TestProduct:
    def test_product_1(self):
        a = FSA(4, {0, 1, 2}, (('', 'a'), ('', 'b'), ('', 'c'),  ('a', ''), ('a', 'a'), ('a', 'b'), ('a', 'c'), ('b', ''), ('b', 'a'), ('b', 'b'), ('b', 'c'), ('c', ''), ('c', 'a'), ('c', 'b'), ('c', 'c')), {('', 'a'): [1, 1, 3, 3], ('', 'b'): [1, 1, 3, 3], ('', 'c'): [1, 1, 3, 3],   ('a', ''): [2, 3, 2, 3], ('a', 'a'): [0, 3, 3, 3], ('a', 'b'): [0, 3, 3, 3], ('a', 'c'): [0, 3, 3, 3],   ('b', ''): [2, 3, 2, 3], ('b', 'a'): [0, 3, 3, 3], ('b', 'b'): [0, 3, 3, 3], ('b', 'c'): [0, 3, 3, 3],  ('c', ''): [2, 3, 2, 3], ('c', 'a'): [0, 3, 3, 3], ('c', 'b'): [0, 3, 3, 3], ('c', 'c'): [0, 3, 3, 3]})
        assert product(f, f) == BFS(a)
    
    def test_product_2(self):
        assert product(f, g) == BFS(FSA(16, {4, 5, 6, 7, 12, 13, 14},
                                        (('', 'a'), ('', 'b'), ('', 'c'), 
                                        ('a', ''), ('a', 'a'), ('a', 'b'), ('a', 'c'),
                                        ('b', ''), ('b', 'a'), ('b', 'b'), ('b', 'c'),
                                        ('c', ''), ('c', 'a'), ('c', 'b'), ('c', 'c')),
                                        {('', 'a'): [7, 7, 11, 11, 7, 7, 11, 11, 13, 13, 9, 9, 7, 7, 15, 15], 
                                         ('', 'b'): [13, 13, 5, 5, 3, 3, 3, 3, 13, 13, 11, 11, 3, 3, 15, 15],
                                         ('', 'c'): [11, 11, 1, 1, 5, 5, 5, 5, 7, 7, 9, 9, 9, 9, 15, 15], 
                                         ('a', ''): [15, 15, 15, 15, 14, 15, 14, 15, 15, 15, 15, 15, 14, 15, 14, 15],
                                         ('a', 'a'): [6, 15, 10, 15, 6, 15, 10, 15, 12, 15, 8, 15, 6, 15, 15, 15],
                                         ('a', 'b'): [12, 15, 4, 15, 2, 15, 2, 15, 12, 15, 10, 15, 2, 15, 15, 15],
 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 85, 80, 82, 82, 83, 84, 84, 87, 87, 87, 87, 87, 87, 87, 87, 87, 85, 80, 82, 82, 83, 84, 84, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 87, 85, 80, 82, 82, 83, 84, 84, 87],
                                         ('c', 'a'): [45, 40, 42, 42, 43, 44, 44, 87, 53, 48, 50, 50, 51, 52, 52, 87, 5, 0, 2, 2, 3, 4, 4, 87, 37, 32, 34, 34, 35, 36, 36, 87, 69, 64, 66, 66, 67, 68, 68, 87, 53, 48, 50, 50, 51, 52, 52, 87, 21, 16, 18, 18, 19, 20, 20, 87, 69, 64, 66, 66, 67, 68, 68, 87, 69, 64, 66, 66, 67, 68, 68, 87, 29, 24, 26, 26, 27, 28, 28, 87, 87, 87, 87, 87, 87, 87, 87, 87],
                                         ('c', 'b'): [13, 8, 10, 10, 11, 12, 12, 87, 13, 8, 10, 10, 11, 12, 12, 87, 37, 32, 34, 34, 35, 36, 36, 87, 37, 32, 34, 34, 35, 36, 36, 87, 13, 8, 10, 10, 11, 12, 12, 87, 69, 64, 66, 66, 67, 68, 68, 87, 77, 72, 74, 74, 75, 76, 76, 87, 29, 24, 26, 26, 27, 28, 28, 87, 45, 40, 42, 42, 43, 44, 44, 87, 37, 32, 34, 34, 35, 36, 36, 87, 87, 87, 87, 87, 87, 87, 87, 87],
                                         ('c', 'c'): [69, 64, 66, 66, 67, 68, 68, 87, 45, 40, 42, 42, 43, 44, 44, 87, 61, 56, 58, 58, 59, 60, 60, 87, 61, 56, 58, 58, 59, 60, 60, 87, 53, 48, 50, 50, 51, 52, 52, 87, 61, 56, 58, 58, 59, 60, 60, 87, 13, 8, 10, 10, 11, 12, 12, 87, 61, 56, 58, 58, 59, 60, 60, 87, 21, 16, 18, 18, 19, 20, 20, 87, 69, 64, 66, 66, 67, 68, 68, 87, 87, 87, 87, 87, 87, 87, 87, 87]}))
                            
class TestProjection:
    def test_projection_1(self):
        assert BFS(product(f, g)) == BFS(projection(product(f, g), [0, 1]))

    def test_projection_2(self):
        assert BFS(h) == BFS(projection(FSA(88, {2, 3, 6, 7, 10, 11, 14, 15, 42, 43, 46, 47, 58, 59, 62, 63, 82, 83, 86},
                                        (('', 'a'), ('', 'b'), ('', 'c'), 
                                        ('a', ''), ('a', 'a'), ('a', 'b'), ('a', 'c'),
                                        ('b', ''), ('b', 'a'), ('b', 'b'), ('b', 'c'),
                                        ('c', ''), ('c', 'a'), ('c', 'b'), ('c', 'c')),
                                        {('', 'a'): [87, 87, 47, 47, 87, 87, 47, 47, 87, 87, 55, 55, 87, 87, 55, 55, 87, 87, 7, 7, 87, 87, 7, 7, 87, 87, 39, 39, 87, 87, 39, 39, 87, 87, 71, 71, 87, 87, 71, 71, 87, 87, 55, 55, 87, 87, 55, 55, 87, 87, 23, 23, 87, 87, 23, 23, 87, 87, 71, 71, 87, 87, 71, 71, 87, 87, 71, 71, 87, 87, 71, 71, 87, 87, 31, 31, 87, 87, 31, 31, 87, 87, 87, 87, 87, 87, 87, 87], 
                                         ...
                                         ('c', 'a'): [45, 40, 42, 42, 43, 44, 44, 87, 53, 48, 50, 50, 51, 52, 52, 87, 5, 0, 2, 2, 3, 4, 4, 87, 37, 32, 34, 34, 35, 36, 36, 87, 69, 64, 66, 66, 67, 68, 68, 87, 53, 48, 50, 50, 51, 52, 52, 87, 21, 16, 18, 18, 19, 20, 20, 87, 69, 64, 66, 66, 67, 68, 68, 87, 69, 64, 66, 66, 67, 68, 68, 87, 29, 24, 26, 26, 27, 28, 28, 87, 87, 87, 87, 87, 87, 87, 87, 87],
                                         ('c', 'b'): [13, 8, 10, 10, 11, 12, 12, 87, 13, 8, 10, 10, 11, 12, 12, 87, 37, 32, 34, 34, 35, 36, 36, 87, 37, 32, 34, 34, 35, 36, 36, 87, 13, 8, 10, 10, 11, 12, 12, 87, 69, 64, 66, 66, 67, 68, 68, 87, 77, 72, 74, 74, 75, 76, 76, 87, 29, 24, 26, 26, 27, 28, 28, 87, 45, 40, 42, 42, 43, 44, 44, 87, 37, 32, 34, 34, 35, 36, 36, 87, 87, 87, 87, 87, 87, 87, 87, 87],
                                         ('c', 'c'): [69, 64, 66, 66, 67, 68, 68, 87, 45, 40, 42, 42, 43, 44, 44, 87, 61, 56, 58, 58, 59, 60, 60, 87, 61, 56, 58, 58, 59, 60, 60, 87, 53, 48, 50, 50, 51, 52, 52, 87, 61, 56, 58, 58, 59, 60, 60, 87, 13, 8, 10, 10, 11, 12, 12, 87, 61, 56, 58, 58, 59, 60, 60, 87, 21, 16, 18, 18, 19, 20, 20, 87, 69, 64, 66, 66, 67, 68, 68, 87, 87, 87, 87, 87, 87, 87, 87, 87]}), [1]))

    def test_projection_3(self):
        # This is similar to what we actually see in pKB: we have an annoying
        # language to describe and we want to project down to the first index.
        a = BFS(FSA(4, [2], (('', 'a'), ('', 'b'), ('a', ''), ('a', 'a'), ('a', 'b'), ('b', ''), ('b', 'a'), ('b', 'b')), 
                    {('', 'a'): [3, 3, 3, 3],
                     ('', 'b'): [3, 3, 3, 3],
                     ('a', ''): [1, 3, 3, 3],
                     ('a', 'a'): [0, 3, 3, 3],
...
class TestSingleton:
    def test_singleton_1(self):
        assert single_word_FSA(('a', 'b'), ['a', 'b', 'a']) == BFS(FSA(5, [3], ('a', 'b'), {'a': [1, 4, 3, 4, 4], 'b': [4, 2, 4, 4, 4]}))

    def test_singleton_2(self):
        assert single_word_FSA(('a', 'b', 'c'), ['a', 'b']) == BFS(FSA(4, [2], ('a', 'b', 'c'), {'a': [1, 3, 3, 3], 'b': [3, 2, 3, 3], 'c': [3, 3, 3, 3]}))

class TestSingletonsDiagonalConcatenate:
    def test_sdc_1(self):
        assert singletons_diagonal_concatenate(['a', 'b'], ['c', 'a'], ('a', 'b', 'c')) == BFS(FSA(4, [2], (('', 'a'), ('', 'b'), ('', 'c'), ('a', ''), ('a', 'a'), ('a', 'b'), ('a', 'c'), ('b', ''), ('b', 'a'), ('b', 'b'), ('b', 'c'), ('c', ''), ('c', 'a'), ('c', 'b'), ('c', 'c')),
                                                                                                   {('', 'a'): [3, 3, 3, 3], 
                                                                                                    ('', 'b'): [3, 3, 3, 3],
                                                                                                    ('', 'c'): [3, 3, 3, 3], 
                                                                                                    ('a', ''): [3, 3, 3, 3],
    ...
    def test_sdc_2(self):
        assert singletons_diagonal_concatenate(['a', 'a'], ['b'], ('a', 'b', 'c')) == BFS(FSA(6, [4], (('', 'a'), ('', 'b'), ('', 'c'), ('a', ''), ('a', 'a'), ('a', 'b'), ('a', 'c'), ('b', ''), ('b', 'a'), ('b', 'b'), ('b', 'c'), ('c', ''), ('c', 'a'), ('c', 'b'), ('c', 'c')),
                                                                                                   {('', 'a'): [5, 5, 5, 5, 5, 5], 
                                                                                                    ('', 'b'): [5, 5, 5, 5, 5, 5],
                                                                                                    ('', 'c'): [5, 5, 5, 5, 5, 5], 
                                                                                                    ('a', ''): [5, 4, 5, 5, 5, 5],
